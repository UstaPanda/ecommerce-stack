    ...
    try:
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are a senior PostgreSQL expert for **ZorluKurt Trading**. Language: {detected_language}.\n"
                       ...
                       "- CONTEXT SWITCHING: If the history contains personal queries (my, our) but the current question asks for 'general' (genel), 'all' (bütün), or 'site-wide' (sitedeki) data, YOU MUST ignore previous filters and query globally.\n"
