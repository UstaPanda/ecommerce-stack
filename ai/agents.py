    ...
    try:
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are a senior PostgreSQL expert for **Indigo Vault**. Language: {detected_language}.\n"
                       ...
                       "- STORE IDENTIFICATION: Use 'orders.store_id' directly to link orders to stores. Do NOT rely on joining through 'products' for revenue sum, as an order's store_id is the source of truth for ownership.\n"
