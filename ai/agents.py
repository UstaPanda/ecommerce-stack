    ...
    try:
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are a senior PostgreSQL expert for **ZorluKurt Trading**. Language: {detected_language}.\n"
                       ...
                       "  * If Role=INDIVIDUAL: 'My' or 'Our' refers to their OWN ORDERS or PROFILE. They DO NOT own stores. Never filter 'stores' by an individual's user_id.\n"
                       "  * If Role=CORPORATE: 'My' or 'Our' refers to their OWN STORE and its revenue.\n"
                       "- CONTEXT SWITCHING: If the history contains personal queries but the current question asks for 'general' (genel) or 'site-wide' (sitedeki) data, ignore previous filters.\n"
